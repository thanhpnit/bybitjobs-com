    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#151718' : '#F4F5F7' }]} edges={['top']}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: isIphoneWithNotch ? 130 : 110 }}>
          ...
          {/* 4.5. Structured Company Info (Dạng List) */}
          <View style={[styles.whiteCard, isDark && styles.darkCard, { marginHorizontal: 16, marginTop: 16, padding: 16, borderRadius: 16 }]}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <Ionicons name="business-outline" size={20} color="#0084FF" />
              ...
              <TouchableOpacity activeOpacity={0.7} onPress={() => setIsEditing(true)}>
                <Text style={{ color: '#0084FF', fontSize: 13, fontWeight: '600' }}>Chỉnh sửa</Text>
              </TouchableOpacity>
            </View>
            <View style={[styles.divider, { backgroundColor: isDark ? '#2C2C2E' : '#ECEFF1', marginBottom: 8 }]} />

            {/* List Item 1: Tên doanh nghiệp */}
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: isDark ? '#2C2C2E' : '#F1F5F9' }}>
              <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <Ionicons name="briefcase-outline" size={18} color="#0084FF" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Tên doanh nghiệp</Text>
                <Text style={{ fontSize: 14, fontWeight: '700', color: isDark ? '#FFF' : '#11181C', marginTop: 2 }}>{companyName}</Text>
              </View>
            </View>

            {/* List Item 2: Trụ sở chính */}
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: isDark ? '#2C2C2E' : '#F1F5F9' }}>
              <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <Ionicons name="location-outline" size={18} color="#0084FF" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Trụ sở chính</Text>
                <Text style={{ fontSize: 14, fontWeight: '600', color: isDark ? '#FFF' : '#11181C', marginTop: 2 }}>{address}</Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: isDark ? '#2C2C2E' : '#F1F5F9' }}>
              <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <Ionicons name="globe-outline" size={18} color="#0084FF" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Website chính thức</Text>
                <Text style={{ fontSize: 14, fontWeight: '600', color: '#0084FF', marginTop: 2 }}>{website}</Text>
              </View>
            </View>

            {/* List Item 4: Email & Hotline */}
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: isDark ? '#2C2C2E' : '#F1F5F9' }}>
              <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <Ionicons name="mail-outline" size={18} color="#0084FF" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Email & Hotline liên hệ</Text>
                <Text style={{ fontSize: 14, fontWeight: '600', color: isDark ? '#FFF' : '#11181C', marginTop: 2 }}>{email} • {phone}</Text>
              </View>
            </View>

            {/* List Item 5: Lĩnh vực & Quy mô */}
            <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: (branches && branches.length > 0) ? 1 : 0, borderBottomColor: isDark ? '#2C2C2E' : '#F1F5F9' }}>
              <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <Ionicons name="people-outline" size={18} color="#0084FF" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Lĩnh vực & Quy mô</Text>
                <Text style={{ fontSize: 14, fontWeight: '600', color: isDark ? '#FFF' : '#11181C', marginTop: 2 }}>{industry} • {scale}</Text>
              </View>
            </View>

            {/* List Item 6: Các chi nhánh khác */}
            {branches && branches.length > 0 && (
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', paddingVertical: 10 }}>
                <View style={{ width: 36, height: 36, borderRadius: 10, backgroundColor: isDark ? '#1C2A3A' : '#E6F4FE', alignItems: 'center', justifyContent: 'center', marginRight: 12, marginTop: 2 }}>
                  <Ionicons name="git-network-outline" size={18} color="#0084FF" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 12, color: isDark ? '#9BA1A6' : '#687076' }}>Văn phòng đại diện ({branches.length})</Text>
                  {branches.map((b) => (
                    <Text key={b.id} style={{ fontSize: 13, color: isDark ? '#E2E8F0' : '#334155', marginTop: 4 }}>
                      • <Text style={{ fontWeight: '600' }}>{b.name}:</Text> {b.address}
                    </Text>
                  ))}
                </View>
              </View>
