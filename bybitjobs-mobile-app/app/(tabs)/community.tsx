    ...
    <SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#151718' : '#F4F5F7' }]}>
      <View style={styles.content}>
        <View style={[styles.iconContainer, { backgroundColor: isDark ? '#1C1C1E' : '#E6F4FE' }]}>
          <Ionicons name="people" size={48} color="#0084FF" />
        </View>
        <Text style={[styles.title, { color: isDark ? '#FFF' : '#11181C' }]}>Cộng đồng</Text>
        <Text style={[styles.subtitle, { color: isDark ? '#9BA1A6' : '#687076' }]}>
          Nơi giao lưu, chia sẻ kinh nghiệm làm việc và kết nối với các thành viên khác.
        </Text>
      </View>
    </SafeAreaView>
  );
